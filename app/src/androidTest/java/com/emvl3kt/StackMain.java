...
import com.xiaomi.IntegerStack;
import com.xiaomi.Stack;
...
public class StackMain {
    ...
    public static void main(Object[] args)
    {
        ...
        try {
            //5 入栈小于初始化栈空间
            integerStack = new IntegerStack(27, false, 10);
            for (int i = 0; i < 5; i++) {
                integerStack.push(i);
                integerStack.push("0");
            }
        ...
        integerStack = new IntegerStack(30,true,5);
       ...
       /* new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    for (int i = 0; i < 50; i++) {
                       System.out.print("integerStack.pop() "+integerStack.pop().toString());
                        Thread.sleep(100);
                    }
                }catch (Exception ex)
                {
